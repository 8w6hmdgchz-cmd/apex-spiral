...
for d in scripts/apex-ecc-runtimeos scripts/apex-fusion-engine scripts/apex-praison-chain scripts/apex-dawn-gate scripts/apex-hygiene scripts/apex-evidence-validator scripts/apex-12factor-agent scripts/apex-phasor-llm scripts/apex-agent-dispatch; do
