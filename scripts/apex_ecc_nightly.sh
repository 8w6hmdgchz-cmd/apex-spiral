...
git add \
  ...
  state/apex-ecc-runtimeos-latest.json state/apex-fusion-engine-latest.json state/apex-fusion-evidence.json state/apex-fusion-evidence-report.json state/apex-praison-activation.json state/apex-12factor-agent-latest.json state/apex-container-backend-latest.json state/apex-phasor-llm-latest.json state/apex-agent-dispatch-latest.json state/apex-cmmi-delivery-latest.json state/apex-memory-admission-latest.json state/apex-memory-admission-evidence-report.json state/phi_tracker_latest.json state/phi_v10_result.json state/phi_history.jsonl state/sigma_memory.json \
